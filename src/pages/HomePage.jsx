  ...
  return (
    <>
      ...
      <section className="flex min-h-0 flex-1 flex-col justify-between gap-4">
        <div className="overflow-hidden rounded-[1.75rem] border border-white/12 bg-white/[0.13] shadow-card backdrop-blur">
          <div className="bg-gradient-to-br from-pink-500/35 via-orange-400/24 to-lime-300/18 p-4 min-[390px]:p-5">
            <div className="mb-5 grid h-16 w-16 place-items-center rounded-[1.35rem] bg-gradient-to-br from-amber-300 via-orange-400 to-pink-500 text-slate-950 shadow-glow animate-floaty min-[390px]:mb-7 min-[390px]:h-20 min-[390px]:w-20 min-[390px]:rounded-[1.75rem]">
            ...
            <h2 className="mt-2 text-4xl font-black leading-none tracking-normal text-white min-[390px]:text-5xl">
              Húzz, nevess, válts módot.
            </h2>
            <p className="mt-3 text-base leading-6 text-white/70 min-[390px]:mt-4 min-[390px]:leading-7">
              Gyors körök, saját pakli, céljátékosok és csapatmód egy telefonra
              szabott kártyás felületen.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-3 p-4 min-[390px]:p-5">
            <div className="rounded-3xl bg-slate-950/38 p-3 ring-1 ring-white/10 min-[390px]:p-4">
